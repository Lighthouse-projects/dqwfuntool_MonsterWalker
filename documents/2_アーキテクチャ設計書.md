...
| データ種別 | キャッシュ方式 | staleTime | 更新タイミング |
|-----------|---------------|-----------|---------------|
| モンスターマスタ | 永続キャッシュ | 24時間 | アプリ起動時 |
| 武器マスタ | 永続キャッシュ | 24時間 | アプリ起動時 |
| 職業マスタ | 永続キャッシュ | 24時間 | アプリ起動時 |
| 攻略情報（検索結果） | 短期キャッシュ | 5分 | 検索実行時 |
| いいね数 | 短期キャッシュ | 1分 | 画面表示時 |
