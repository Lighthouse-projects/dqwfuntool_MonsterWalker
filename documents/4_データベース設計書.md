...
10. role_type_enum 型（ENUM）
11. mw_strategy_members テーブル
12. mw_likes テーブル
13. mw_favorites_strategies テーブル
14. mw_favorites_searches テーブル
15. mw_reports テーブル
16. request_category_enum 型（ENUM）
17. request_status_enum 型（ENUM）
18. mw_requests テーブル
